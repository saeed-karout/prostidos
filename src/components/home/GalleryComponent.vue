<template>
  <div class=" h-[70vh] w-full  overflow-hidden relative flex gap-[88px] py-[96px] justify-center items-end">
    <video
...
import video from '@/assets/new-video/production-reel.mp4'
const {  t } = useI18n();
</script>
<style scoped>
.bg-gradient {
